...
if((TARGET protobuf::libprotobuf OR TARGET protobuf::libprotobuf-lite) AND TARGET protobuf::protoc)
  ...
  # modern targets.
  message(STATUS "tts_system: Found protobuf with new-style protobuf targets.")
elseif(Protobuf_FOUND OR PROTOBUF_FOUND)
  ...
  if((NOT PROTOBUF_LIBRARY) AND (NOT PROTOBUF_LITE_LIBRARY))
    message(FATAL_ERROR
      "tts_system: Found protobuf with old style targets, but could not find targets."
      " PROTOBUF_LIBRARY: " ${PROTOBUF_LIBRARY}
      " PROTOBUF_LITE_LIBRARY: " ${PROTOBUF_LITE_LIBRARY}
      " Protobuf_LIBRARY: " ${Protobuf_LIBRARY}
      " Protobuf_LITE_LIBRARY: " ${Protobuf_LITE_LIBRARY})
  endif()
  message(STATUS "tts_system: Found protobuf with old-style protobuf targets.")
...
if((NOT TARGET protobuf::libprotobuf) AND (NOT TARGET protobuf::libprotobuf-lite))
  message(WARNING
    "Protobuf cannot be found. Depending on whether you are building tts_system "
    "or a tts_system dependent library, the next warning / error will give you "
    "more info.")
endif()
