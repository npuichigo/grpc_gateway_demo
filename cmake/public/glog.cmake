...
if(TARGET glog::glog)
  message(STATUS "tts_system: Found glog with new-style glog target.")
elseif(GLOG_FOUND)
  message(
    STATUS
    "tts_system: Found glog with old-style glog starget. Glog never shipped "
  ...
  message(STATUS "tts_system: Cannot find glog automatically. Using legacy find.")
  ...
  if(GLOG_FOUND)
    message(STATUS
      "tts_system: Found glog (include: ${GLOG_INCLUDE_DIR}, "
...
if(NOT TARGET glog::glog)
  message(WARNING "tts_system: glog cannot be found.")
endif()
